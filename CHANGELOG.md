...
* `2025-10-28 16:27:56` : [OAC-1313] Added new [logind configuration](./config/logind/10_BCLD-logind.conf), since XF86 controls barely make a difference
...
* `2025-06-04 13:27:28` : [OAC-1282] Changing NW logging to `NW_PRE_ARGS` from `BCLD_OPTS`
  ...
  * Removed from [environment](./config/bash/environment)
...
* `2025-05-09 17:11:36` : Set Debian repo arch to AMD64 (64-bit packages only)
  * Improved [file operations](./script/file_operations.sh)
