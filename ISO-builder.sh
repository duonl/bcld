...
UBUNTU_DIR="${EFI_DIR}/ubuntu/x86_64-efi"

### Dependencies
#### ISOLINUX/Grub
BIOS_IMG="${ISOLINUX_DIR}/bios.img"
CORE_IMG="${ISOLINUX_DIR}/core.img"
UBUNTU_GRUB="${EFI_DIR}/ubuntu/grub.cfg"
# UBUNTU_NTFS="${UBUNTU_DIR}/ntfs.mod"
...
# ## NTFS module
# copy_file '/usr/lib/grub/x86_64-efi/ntfs.mod' "${UBUNTU_NTFS}"
